...
public class string_1 { 
	...
	System.out.println("A primeira vez que vemos o 'r' eh na posicao: "+ pos);
	
	//buscam o índice do início da substring buscada.
	String LABEL = "Carrefour";
	int posi = LABEL.lastIndexOf("r");
	System.out.println("A Ultima vez que vemos o 'r' eh na posicao: " + posi);
	///Em resumo, a diferença principal entre indexOf e lastIndexOf é a direção em que a busca é feita na String. indexOf começa a busca do início para o final, retornando a posição da primeira ocorrência, enquanto lastIndexOf começa a busca do final para o início, 

	///O método String compareTo (String) pode ser usado para determinar a ordem de strings: maior que, igual ou menor que.
	
	///compareTo determina se é maior que, menor que ou igual. E retorna um valor negativo se for menor, positivo se for maior ou zero se as strings forem iguais.
	///compareToIgnoreCase faz a mesma coisa, mas a compareTo considera letras maiusculas e minusculas, essa função ignora.
